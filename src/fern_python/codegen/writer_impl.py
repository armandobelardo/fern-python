...
class WriterImpl(AST.Writer):
    def __init__(
        ...
        *,
        ...
        self._line_length = (
            SNIPPET_LINE_LENGTH if should_format_as_snippet else DEFAULT_LINE_LENGTH
        )
        self._should_include_header = should_include_header
        self._should_sort_imports = (
            should_sort_imports if should_sort_imports is not None else should_format
        )
    ...
    def write(self, content: str) -> None:
        ...
        content_without_trailing_newline = (
            content[:-1] if content_ends_in_newline else content
        )
